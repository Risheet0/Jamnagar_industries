        ...
        >
          ...
          <div id="salary-slip-print-area">
            ...
            <div className="company" style={{ textAlign: 'center', paddingBottom: '12px', borderBottom: '2px solid #1e3a8a', marginBottom: '16px' }}>
              <div style={{ fontWeight: 700, fontSize: '16px', color: '#1e3a8a' }}>{companyProfile.name}</div>
              <div style={{ fontSize: '11px', color: '#64748b', marginTop: '2px' }}>{companyProfile.location ? `${companyProfile.location} • Operations Control` : 'Industrial Plant & Operations Control'}</div>
